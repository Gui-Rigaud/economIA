                ...
                {primeiraRenderizacao.current ? (
                    <div className="flex items-center justify-center h-screen">
                        <button
                            ...
                            className="bg-econGreen hover:bg-green-700 text-white font-bold py-6 px-6 rounded-full w-30 h-35 flex items-center justify-center text-2xl duration-300"
                        >
